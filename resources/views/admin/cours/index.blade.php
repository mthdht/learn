                ...
                <table class="w-full">
                    <tr class="hover:bg-gray-200">
                        ...
                        <td class="p-2 flex justify-between">
                            <a href="{{ route('admin.cours.show', ['cour' => 'conditions']) }}" class="w-8 h-8 flex items-center justify-center bg-blue-500 rounded text-white"><i class="fas fa-eye"></i></a>
                            <a href="{{ route('admin.cours.edit', ['cour' => 'conditions']) }}" class="w-8 h-8 flex items-center justify-center bg-orange-500 rounded text-white"><i class="fas fa-pencil-alt"></i></a>
                        </td>
                    </tr>
