...
<div class="flex flex-col flex-wrap -mx-2 h-auto max-w-full" id="masonry">
            ...
            <div class="flex-grow">
                ...
                @foreach($category->courses as $course)
                    <tr class="hover:bg-gray-200 flex items-center">
                        ...
                        <td class="p-2 flex">
                            <a href="{{ route('admin.cours.show', ['course' => $course->slug]) }}" class="w-8 h-8 flex items-center justify-center bg-blue-500 rounded text-white mr-2"><i class="fas fa-eye"></i></a>
                            <a href="{{ route('admin.cours.edit', ['course' => $course->slug]) }}" class="w-8 h-8 flex items-center justify-center bg-orange-500 rounded text-white"><i class="fas fa-pencil-alt"></i></a>
                        </td>
                    </tr>  
                @endforeach
                </table>
